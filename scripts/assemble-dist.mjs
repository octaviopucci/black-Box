...
const thaianeDist = join(root, 'apps', 'thaiane-marcon-adv', 'dist')
...
if (!existsSync(thaianeDist)) {
  throw new Error('apps/thaiane-marcon-adv/dist não encontrado — rode build:thaiane')
}
...
function publish(target) {
  ...
  mkdirSync(join(target, 'thaiane-marcon-adv'), { recursive: true })
  cpSync(thaianeDist, join(target, 'thaiane-marcon-adv'), { recursive: true })
