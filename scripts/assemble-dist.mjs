...
const odontomedDist = join(root, 'apps', 'odontomed', 'dist')
...
if (!existsSync(odontomedDist)) {
  throw new Error('apps/odontomed/dist não encontrado — rode build:odontomed')
}
...
function publish(target) {
  ...
  mkdirSync(join(target, 'odontomed'), { recursive: true })
  cpSync(odontomedDist, join(target, 'odontomed'), { recursive: true })
