...
export const PERMISSIONS = {
  ...
  OPPORTUNITY_MOVE: 'opportunity.move',
  OPPORTUNITY_INTERACTION_READ: 'opportunity.interaction.read',
  OPPORTUNITY_INTERACTION_CREATE: 'opportunity.interaction.create',
...
export const ALL_PERMISSION_DEFINITIONS: Array<{
  ...
  { key: PERMISSIONS.OPPORTUNITY_UPDATE, name: 'Update opportunities', description: 'Modify opportunities' },
  { key: PERMISSIONS.OPPORTUNITY_MOVE, name: 'Move opportunities', description: 'Move opportunities between stages' },
  { key: PERMISSIONS.OPPORTUNITY_INTERACTION_READ, name: 'Read opportunity interactions', description: 'View CRM interactions' },
  { key: PERMISSIONS.OPPORTUNITY_INTERACTION_CREATE, name: 'Create opportunity interactions', description: 'Record CRM interactions' },
  { key: PERMISSIONS.PIPELINE_READ, name: 'Read pipelines', description: 'View CRM pipelines' },
  { key: PERMISSIONS.PIPELINE_CREATE, name: 'Create pipelines', description: 'Create CRM pipelines' },
  { key: PERMISSIONS.PIPELINE_UPDATE, name: 'Update pipelines', description: 'Modify CRM pipelines' },
  { key: PERMISSIONS.STAGE_CREATE, name: 'Create stages', description: 'Create pipeline stages' },
  { key: PERMISSIONS.STAGE_UPDATE, name: 'Update stages', description: 'Modify pipeline stages' },
...
export const GESTOR_PERMISSION_KEYS: PermissionKey[] = [
  ...
  PERMISSIONS.OPPORTUNITY_MOVE,
  PERMISSIONS.OPPORTUNITY_INTERACTION_READ,
  PERMISSIONS.OPPORTUNITY_INTERACTION_CREATE,
