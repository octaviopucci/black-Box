...
export const PERMISSIONS = {
  ...
  SALE_CONFIRM_PAYMENT: 'sale.confirm_payment',
  CUSTOMER_READ: 'customer.read',
  CUSTOMER_CREATE: 'customer.create',
  CUSTOMER_UPDATE: 'customer.update',
  CUSTOMER_CONVERT: 'customer.convert',
...
export const ALL_PERMISSION_DEFINITIONS: Array<{
  ...
  { key: PERMISSIONS.SALE_UPDATE, name: 'Update sales', description: 'Modify sales' },
  { key: PERMISSIONS.SALE_CONFIRM_PAYMENT, name: 'Confirm sale payment', description: 'Confirm manual payment for sales' },
  { key: PERMISSIONS.CUSTOMER_READ, name: 'Read customers', description: 'View customers' },
  { key: PERMISSIONS.CUSTOMER_CREATE, name: 'Create customers', description: 'Create customers' },
  { key: PERMISSIONS.CUSTOMER_UPDATE, name: 'Update customers', description: 'Modify customers' },
  { key: PERMISSIONS.CUSTOMER_CONVERT, name: 'Convert lead to customer', description: 'Convert leads into customers' },
...
export const GESTOR_PERMISSION_KEYS: PermissionKey[] = [
  ...
  PERMISSIONS.SALE_CONFIRM_PAYMENT,
  PERMISSIONS.CUSTOMER_READ,
  PERMISSIONS.CUSTOMER_CREATE,
  PERMISSIONS.CUSTOMER_UPDATE,
  PERMISSIONS.CUSTOMER_CONVERT,
