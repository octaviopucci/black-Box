...
export function Gallery() {
  ...
  const filters: { id: GalleryCategory; label: string }[] = [
    ...
    { id: "realismo", label: t.gallery.filters.realismo },
    { id: "cobertura", label: t.gallery.filters.cobertura },
    { id: "delicadas", label: t.gallery.filters.delicadas },
    { id: "estilos", label: t.gallery.filters.estilos },
  ];
              ...
              <button
                ...
                className={cn(
                  ...
                  filter === item.id
                    ...
                    : "border border-white/15 text-mute hover:border-accent hover:text-accent",
                )}
              >
                {item.label}
