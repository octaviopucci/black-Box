        ...
        <div className="mt-16 grid items-start gap-16 lg:grid-cols-[1fr_280px]">
          <Reveal className="space-y-6">
            ...
            <p className="max-w-2xl text-base leading-relaxed text-mute md:text-lg">
              A {site.name} trabalha com seminovos selecionados em {site.city}.
              Cada carro anunciado está na loja, com o valor no anúncio e as
              fotos da unidade — sincronizado com o gestor LP Motors, sem banco
              de imagem.
            </p>
            ...
            >
              {expanded ? "← Versão resumida" : `Como a ${site.name} trabalha →`}
            </button>
          </Reveal>
