  ...
  return (
    ...
    >
      <div className="sticky top-0 flex h-[100svh] min-h-[720px] items-end overflow-hidden bg-paper">
        ...
        <div
          className="absolute inset-0 z-[2] bg-gradient-to-t from-paper via-paper/50 to-paper/20"
          style={{ opacity: sideOverlay * 0.95 }}
        />
        <div
          className="absolute inset-0 z-[2] bg-gradient-to-r from-paper via-paper/45 to-transparent"
          style={{ opacity: sideOverlay }}
        />
        <div
          className="absolute inset-0 z-[2] bg-accent-soft/25"
        ...
        >
          <div className="grid items-end gap-10 lg:grid-cols-[minmax(0,1fr)_min(42%,480px)]">
            <div className="max-w-2xl">
              <p className="hero-enter-item font-mono text-[10px] uppercase tracking-[0.42em] text-mute/70">
                {t.hero.eyebrow}
              </p>

              <h1 className="hero-enter-item mt-5 text-[clamp(2.4rem,7.5vw,4.75rem)] font-bold uppercase leading-[0.9] tracking-tighter text-ink [animation-delay:0.08s]">
              ...
              <p className="hero-enter-item mt-5 max-w-md text-sm leading-relaxed text-mute md:text-base [animation-delay:0.28s]">
                {t.hero.subtitle}
              </p>
