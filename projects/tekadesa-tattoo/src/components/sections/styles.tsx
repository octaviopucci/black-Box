        ...
        <div className="mt-16 space-y-0">
          {siteData.styles.map((style, index) => (
            <Reveal key={style.title} delay={index * 0.06}>
              <article className="group grid gap-8 border-t border-line/60 py-12 md:grid-cols-[72px_1fr_180px] md:items-start">
                <span className="font-mono text-4xl font-light leading-none text-accent-soft md:text-5xl">
