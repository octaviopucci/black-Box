...
export function CategoryCard({ name, slug, image }: CategoryCardProps) {
  ...
  return (
    <Link
      href={href}
      className="group relative overflow-hidden rounded-2xl border border-brand-border-light bg-white transition-all duration-300 hover:-translate-y-1 hover:border-brand-purple hover:shadow-[0_12px_40px_rgba(147,51,234,0.15)]"
    >
      ...
      <div className="flex items-center justify-between p-4">
        ...
        <span className="flex h-8 w-8 items-center justify-center rounded-full bg-brand-light text-brand-black transition-colors group-hover:bg-brand-purple">
