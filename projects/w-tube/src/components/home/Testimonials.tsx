      ...
      <div className="container-store">
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {testimonials.map((t) => (
            <div
              key={t.name}
              className="rounded-2xl border border-brand-border-light bg-brand-light p-6 transition-all hover:border-brand-purple/50 hover:shadow-[0_8px_30px_rgba(147,51,234,0.1)]"
            >
