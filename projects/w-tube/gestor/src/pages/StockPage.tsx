                ...
                <tr key={u.id} className="border-t border-brand-border">
                  ...
                  <td className="p-3">
                    <span className={`rounded px-2 py-0.5 text-xs font-bold ${
                      ...
                      u.status === 'sold' ? 'bg-brand-muted/30 text-brand-purple' : 'bg-brand-border text-brand-gray'
                    }`}>
                      {u.status}
                    </span>
                  </td>
                  ...
                  <td className="p-3">
                    {u.status === 'available' && (
                      <button onClick={() => setStatus(u.id, 'sold')} className="text-xs text-brand-purple hover:underline">
                        Marcar vendido
                      </button>
                    )}
                  </td>
