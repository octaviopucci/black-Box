  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      <form onSubmit={handleSubmit} className="card w-full max-w-md space-y-3">
        ...
        {slug && <p className="text-sm text-brand-purple">Código da loja: {slug}</p>}
        ...
        <p className="text-center text-sm text-brand-gray">
          Já tem conta? <Link to="/login" className="text-brand-purple hover:text-brand-accent">Entrar</Link>
        </p>
      </form>
    </div>
  )
