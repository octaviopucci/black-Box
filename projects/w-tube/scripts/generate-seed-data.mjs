...
const db = {
  version: 1,
  organization: { id: ORG_ID, name: 'W-Tube', slug: 'w-tube', createdAt: now },
  stores: [
    {
      id: STORE_ID,
      organizationId: ORG_ID,
...
writeFileSync('api/_w-tube/seed-data.json', JSON.stringify(db, null, 2))
