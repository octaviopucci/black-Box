...
const DB_KEY = 'iphone_imports_gestor_db'
const SESSION_KEY = 'iphone_imports_gestor_session'
const TOKEN_KEY = 'iphone_imports_gestor_token'
const SYNC_KEY = 'iphone_imports_gestor_sync'
