      ...
      <div className="container-store">
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {testimonials.map((t) => (
            <div
              key={t.name}
              className="rounded-2xl border border-brand-border-light bg-white p-6 transition-all hover:border-brand-silver/40 hover:shadow-[0_8px_30px_rgba(255,106,0,0.1)]"
            >
