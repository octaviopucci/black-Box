  ...
  return (
    <section className="relative overflow-hidden bg-brand-black py-16 md:py-20">
      ...
      <div className="container-store relative text-center">
        <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-silver/15 ring-1 ring-brand-silver/30">
          <MessageCircle className="h-7 w-7 text-brand-silver" />
        </div>
