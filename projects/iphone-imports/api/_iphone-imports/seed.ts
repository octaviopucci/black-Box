...
export const STORE_SLUG = 'iphone-imports'
export const ADMIN_USERNAME = 'admin'
export const ADMIN_PASSWORD = 'adminimports123'
export const ORG_ID = 'org_iphone_imports'
...
/** Garante a loja única iPhone Imports com catálogo e estoque iniciais. */
export async function ensureIphoneImportsStore(
  ...
  // Não re-seed por catálogo vazio — isso apagava alterações do gestor.
