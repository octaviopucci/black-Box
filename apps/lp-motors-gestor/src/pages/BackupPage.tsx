...
export function BackupPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="section-title">Backup</h1>
        <p className="section-sub">Exporte, importe e restaure a base JSON completa do sistema</p>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <section className="panel space-y-4 p-5">
          <h2 className="font-display text-lg font-semibold">Exportar / Importar</h2>
          <p className="text-sm text-lp-steel">
            O backup inclui veículos, vendas, despesas, clientes, usuários, configurações e histórico.
          </p>
        ...
        <section className="panel space-y-4 p-5">
          <h2 className="font-display text-lg font-semibold">Restaurar / Resetar</h2>
          <p className="text-sm text-lp-steel">
            Restaurar demo carrega dados de exemplo. Resetar limpa tudo mantendo usuários padrão.
          </p>
          <div className="flex flex-wrap gap-2">
