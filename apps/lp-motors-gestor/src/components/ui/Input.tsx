...
export const Checkbox = forwardRef<HTMLInputElement, CheckboxProps>(function Checkbox(
  ...
  return (
    <label className={cn('inline-flex cursor-pointer items-center gap-2 text-sm text-lp-steel', className)}>
      <input
        ref={ref}
        type="checkbox"
        className="h-4 w-4 rounded border-lp-line accent-lp-accent"
        {...props}
      />
      {label}
    </label>
