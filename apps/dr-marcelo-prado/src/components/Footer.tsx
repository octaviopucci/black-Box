...
export function Footer() {
  return (
    <footer className="border-t border-snow/10 bg-ink text-snow">
      <div className="mx-auto grid max-w-7xl gap-14 px-5 py-16 sm:px-8 lg:grid-cols-[1.25fr_1fr_1fr]">
        <div>
          <Link to="/" className="inline-flex items-center gap-3">
            <span className="flex h-11 w-11 items-center justify-center rounded-full bg-aqua font-display text-sm font-semibold text-snow">
              {site.shortName}
            </span>
            <span>
          ...
          <ul className="mt-5 space-y-3 text-sm text-snow/65">
            ...
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="transition hover:text-aqua-light"
              >
