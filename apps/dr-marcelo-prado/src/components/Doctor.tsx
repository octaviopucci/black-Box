        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          {site.proof.map((item, i) => (
            <Reveal key={item.label} delay={0.06 * i}>
              <div className="relative pl-5 before:absolute before:left-0 before:top-1 before:h-10 before:w-0.5 before:bg-aqua">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 sm:px-8 lg:grid-cols-2 lg:gap-16">
        ...
        <div>
          <Reveal>
            ...
            <h2 className="font-display text-[clamp(2.2rem,5vw,3.3rem)] font-semibold leading-[1.05] tracking-tight text-ink text-balance">
            ...
            {site.protocolo.points.map((p, i) => (
              <Reveal key={p} delay={0.08 * i}>
                <li className="flex items-start gap-3 border-b border-line pb-4">
                  <span className="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-aqua" />
          ...
          <div className="grid items-center gap-8 py-10 lg:grid-cols-[1fr_280px] lg:gap-12 lg:py-0">
            <div className="lg:py-12">
              ...
              <a
                ...
                className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-aqua-light transition hover:text-aqua-light-soft"
              >
                Ver no Instagram
        ...
        <Reveal>
          <div className="relative">
            ...
            <div className="absolute -bottom-5 left-5 right-5 rounded-2xl bg-ink p-5 text-snow shadow-lift sm:left-auto sm:right-[-1rem] sm:w-64">
              <p className="text-[10px] font-bold uppercase tracking-[0.28em] text-aqua-light">
                Presença real
              </p>
