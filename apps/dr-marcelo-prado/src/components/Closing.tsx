      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-5 sm:px-8 md:flex-row md:items-end md:justify-between md:pl-28">
        <div>
          <Link to="/" className="inline-flex items-center gap-3">
            <span className="flex h-11 w-11 items-center justify-center rounded-full bg-signal/15 font-display text-sm font-semibold text-signal ring-1 ring-signal/30">
              {site.shortName}
            </span>
            <div>
