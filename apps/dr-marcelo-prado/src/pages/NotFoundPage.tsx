  ...
  return (
    <div className="min-h-screen bg-ink text-snow">
      ...
      <main className="mx-auto flex min-h-[70vh] max-w-3xl flex-col items-start justify-center px-5 py-32 sm:px-8">
        <p className="text-[11px] font-bold uppercase tracking-[0.3em] text-aqua-light">404</p>
        ...
        <Link
          to="/"
          className="mt-10 rounded-full bg-aqua px-6 py-3 text-sm font-bold text-snow"
        >
