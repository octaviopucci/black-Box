...
import { affiliate, brand, plans } from '@/data/site'
    ...
    <div className="min-h-dvh bg-ink px-4 py-8 text-paper sm:px-6">
      <div className="mx-auto w-full max-w-md">
        ...
        <p className="mt-3 text-sm leading-relaxed text-mist">
          Faça o cadastro no app com o mesmo e-mail da compra na Kiwify. Se a compra já estiver
          aprovada na base, o acesso libera sozinho; caso contrário, complete o pagamento abaixo.
        </p>
