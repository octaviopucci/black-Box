...
export const plans = [
  {
    ...
    badge: 'Flexível',
    perks: [
      'Acesso completo ao BASE',
      'Protocolo PAV',
      'Arena + Botão de Fissura',
  ...
  },
  {
    ...
    perks: [
      'Tudo do Mensal',
      'Melhor ritmo pra criar base',
      'Economia vs. mês a mês',
      'Comunidade',
      'Garantia 30 dias',
    ],
  },
  {
    ...
    perks: [
      'Tudo do Trimestral',
      'Menor custo por mês',
      'Pra quem já decidiu sustentar',
      'Próximos protocolos inclusos na evolução',
      'Garantia 30 dias',
    ],
  },
] as const
