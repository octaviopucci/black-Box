    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-14 px-5 py-24 sm:px-8 lg:grid-cols-12 lg:py-32">
        <Reveal className="lg:col-span-6">
          ...
          <h2 className="display-title mt-4 max-w-md text-3xl sm:text-4xl">
        ...
        <Reveal delay={0.1} className="lg:col-span-5 lg:col-start-8">
          ...
          <h3 className="display-title mt-3 text-3xl">O que as alunas dizem</h3>
          <p className="mt-8 font-display text-2xl leading-snug text-white/90">
            “{studentNote.text}”
          </p>
          <p className="mt-5 text-xs uppercase tracking-[0.22em] text-gold">{studentNote.from}</p>
