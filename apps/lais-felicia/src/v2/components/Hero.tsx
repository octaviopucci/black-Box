    ...
    <section id="topo" className="overflow-hidden pt-24 sm:pt-28">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <div className="lg:hidden">
          <div className="relative mx-auto mb-6 max-w-sm overflow-hidden rounded-2xl border border-gold/25 bg-surface-lift px-5 py-5 text-center backdrop-blur">
...
function HeroMedia({ videoRef, scrub }: { videoRef: RefObject<HTMLVideoElement | null>; scrub: boolean }) {
  ...
  return (
    <div className="absolute -inset-x-0 -top-3 bottom-0 z-0 bg-surface">
      <img
        src={poster}
        alt=""
        aria-hidden
...
export function Hero() {
  ...
  return (
    <section id="topo" ref={sectionRef} data-video-slot className="relative isolate overflow-hidden bg-surface">
