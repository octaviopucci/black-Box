...
export function SettingsPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="font-display text-3xl font-bold tracking-wide">Configurações</h1>
        <p className="mt-1 text-sm text-white/50">Dados da empresa e preferências do sistema</p>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <section className="panel flex flex-col items-center justify-center gap-4 p-6 lg:col-span-1">
          ...
          <p className="text-center text-sm text-white/50">Pré-visualização da marca</p>
        </section>
