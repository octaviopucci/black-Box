      ...
      <div className="h-72">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data}>
            ...
            <YAxis stroke="#888" fontSize={12} tickFormatter={(v) => `${Math.round(v / 1000)}k`} />
            <Tooltip
            ...
            />
            <Legend />
            <Line type="monotone" dataKey="vendas" name="Vendas" stroke="#C41E3A" strokeWidth={2.5} dot={false} />
            <Line type="monotone" dataKey="lucro" name="Lucro" stroke="#22C55E" strokeWidth={2.5} dot={false} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
